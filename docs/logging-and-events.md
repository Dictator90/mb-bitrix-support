...
Пакет `mb4it/bitrix-support` предоставляет унифицированный слой логирования, который использует:
...
> **См. также:** [UI-подсистема](ui.md) — для отображения уведомлений в административном интерфейсе.
