...
use MB\Bitrix\UI\Control\Tab\CustomTab;
...
final class Builder
{
    ...
    public function __construct(Options\Base|Options\Collection $options, ?GridBase $grid = null)
    {
